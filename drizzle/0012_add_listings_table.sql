...
--> statement-breakpoint
ALTER TABLE "cars" ADD COLUMN "listing_id" integer;
--> statement-breakpoint
ALTER TABLE "cars" ADD CONSTRAINT "cars_listing_id_listings_id_fk" FOREIGN KEY ("listing_id") REFERENCES "public"."listings"("id") ON DELETE no action ON UPDATE no action;
--> statement-breakpoint
ALTER TABLE "cars" ADD CONSTRAINT "listing_fk" FOREIGN KEY ("listing_id") REFERENCES "public"."listings"("id") ON DELETE no action ON UPDATE no action;
--> statement-breakpoint
